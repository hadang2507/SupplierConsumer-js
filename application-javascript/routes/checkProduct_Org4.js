...
router.get("/", async function (req, res){
	try {
		...
		try {
            ...
            //Check if product exists, if yes then return true
			console.log('\n--> Evaluate Transaction: ProductExists, function returns "true" if a Product with given ID exist');
			result = await contract.evaluateTransaction('ProductExists', 'I1');
